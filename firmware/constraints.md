...
Without it the readings come out too low, by an amount that depends on which channel was read before — detection would quietly vary with where the balls are. The setting costs 600 ns per reading against a 300 µs phase.
